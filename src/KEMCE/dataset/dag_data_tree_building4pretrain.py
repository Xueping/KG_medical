...
if __name__ == '__main__':
    ...
    seqFile = dir_path + 'outputs/kemce/data/raw/mimic_pre_train.seqs'
    typeFile = dir_path + 'outputs/kemce/data/raw/mimic_pre_train_vocab.txt'
    outFile = dir_path + 'outputs/kemce/data/mimic/mimic_pre_train'
