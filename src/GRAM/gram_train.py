...
from GRAM.gram_helpers import train_model, calculate_dimSize, get_rootCode, build_tree, load_data, print2file
...
model_path = dir_path + 'outputs/gram/model/ccs_single_level/accuracy'
